...
const DietCategoryDetailScreen = ({ navigation }) => {
                ...
                </Text>
                {
                    dietPlans.map((item, index) => (
                        <TouchableOpacity
                            ...
                            key={`${item.id}`}
                            style={{ flexDirection: isRtl ? 'row-reverse' : 'row', alignItems: 'center', marginBottom: Sizes.fixPadding * 2.0, }}
                        >
                            <Image
    ...
    function dietDescription() {
        return (
            <Text style={{ marginVertical: Sizes.fixPadding * 2.0, ...Fonts.grayColor14Medium }}>
